...
sudo pacman -S libreoffice-still libreoffice-still-pt-br virtualbox postgresql flameshot bat bashtop codeblocks docker geogebra gimp git mysql-workbench noto-fonts-emoji jdk-openjdk openssh kleopatra gnome-keyring qbittorrent telegram-desktop unrar unzip virtualbox vlc zsh networkmanager --needed
