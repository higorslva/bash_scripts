...
pacman -S gnome-shell gnome-shell-extensions gnome-terminal nautilus gnome-tweaks gdm gedit gnome-disk-utility gnome-keyring gnome-photos gdm gnome-calculator gnome-calendar gnome-backgrounds gedit xf86-video-intel xdg-desktop-portal-gnome eog file-roller --needed
